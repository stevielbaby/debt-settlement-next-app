...
import { ViolationsChecklist } from '@/app/components/ViolationsChecklist';
import { useRouter } from 'next/navigation';

export default function ViolationsChecklistPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 selection:bg-orange-600 selection:text-white overflow-x-hidden">
      ...
      <div className="pt-32 pb-20">
        <ViolationsChecklist onBack={() => router.back()} />
      </div>
    </div>
  );
}
